	...
	\bookpart {
		\markup {
			\column {
				...
				\fill-line { \small "Build date: 16:27:40 22-02-2023" }
      ...
      \score {
        {
          ...
          s^\markup {
            \fill-line {
                \fontsize #3 \lower #1 \rotate #7 "בלדת רוק"
              \fontsize #8
              \override #'(offset . 7)
              \override #'(thickness . 6)
              \underline \sans "איך הוא שר"
      ...
      \score {
        {
          ...
          s^\markup {
            \fill-line {
                \fontsize #3 \lower #1 \rotate #7 "שירי ארץ ישראל"
              \fontsize #8
              \override #'(offset . 7)
              \override #'(thickness . 6)
              \underline \sans "הרדופים ליד החוף"
              \fontsize #1 \lower #1 \line {
	                               "מלים: נתן יונתן"
	                               "לחן: שלמה ארצי"
				     }
      ...
      \score {
        {
          ...
          s^\markup {
            \fill-line {
              ...
              \override #'(offset . 7)
              \override #'(thickness . 6)
              \underline \sans "היא חזרה בתשובה"
              \fontsize #1 \lower #1 \line {
	                               "מלים: יעקב רוטבליט"
	                               "לחן: מתי כספי"
				     }
      ...
      \score {
        {
          ...
          s^\markup {
            \fill-line {
              ...
              \override #'(offset . 7)
              \override #'(thickness . 6)
              \underline \sans "לא יכולתי לעשות כלום"
              \fontsize #1 \lower #1 \line {
	                               "מלים: יונה וולך"
	                               "לחן: אילן וירצברג"
				     }
      ...
      \score {
        {
          ...
          s^\markup {
            \fill-line {
                \fontsize #3 \lower #1 \rotate #7 "בלדה מתונה"
              \fontsize #8
              \override #'(offset . 7)
              \override #'(thickness . 6)
              \underline \sans "סליחות"
              \fontsize #1 \lower #1 \line {
	                               "מלים: לאה גולדברג"
	                               "לחן: עודד לרר"
				     }
      ...
      \score {
        {
          ...
          s^\markup {
            \fill-line {
                \fontsize #3 \lower #1 \rotate #7 "רוקנרול"
              \fontsize #8
              \override #'(offset . 7)
              \override #'(thickness . 6)
              \underline \sans "יום שישי את יודעת"
              \fontsize #1 \lower #1 \line {
	                               "מלים: יעקב גלעד"
	                               "לחן: יהודה פוליקר"
				     }
