	...
	\bookpart {
		\markup {
			\column {
				...
				\fill-line { \small "Build date: 16:27:49 22-02-2023" }
      ...
      \score {
        {
          ...
          s^\markup {
            \fill-line {
              ...
              \underline \sans "Ain't No Sunshine"
      ...
      \score {
        {
          ...
          s^\markup {
            \fill-line {
                \fontsize #3 \lower #1 \rotate #7 "Pop"
              \fontsize #8
              \override #'(offset . 7)
              \override #'(thickness . 6)
              \underline \sans "Baby One More Time"
              \fontsize #1 \lower #1 \line {
	                               ""
	                               "- Max Martin"
				     }
      ...
      \score {
        {
          ...
          s^\markup {
            \fill-line {
              ...
              \override #'(offset . 7)
              \override #'(thickness . 6)
              \underline \sans "Have I told you lately that I love you"
              \fontsize #1 \lower #1 \line {
	                               ""
	                               ""
				     }
      ...
      \score {
        {
          ...
          s^\markup {
            \fill-line {
              ...
              \override #'(offset . 7)
              \override #'(thickness . 6)
              \underline \sans "Shape of My Heart"
              \fontsize #1 \lower #1 \line {
	                               "Lyrics by Sting"
      ...
      \score {
        {
          ...
          s^\markup {
            \fill-line {
                \fontsize #3 \lower #1 \rotate #7 "upbeat"
              \fontsize #8
              \override #'(offset . 7)
              \override #'(thickness . 6)
              \underline \sans "Talkin' Bout A Revolution"
              \fontsize #1 \lower #1 \line {
	                               ""
	                               "- Tracy Chapman"
				     }
