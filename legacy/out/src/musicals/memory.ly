      ...
      \score {
        {
          ...
          s^\markup {
            \fill-line {
                \fontsize #3 \lower #1 \rotate #7 "Musical"
              \fontsize #8
              \override #'(offset . 7)
              \override #'(thickness . 6)
              \underline \sans "Memory"
              \fontsize #1 \lower #1 \line {
	      		   	       "- Trevor Nunn after T.S. Eliot / Andrew Lloyd Webber"
...
%% just a little space
	\null
	\fill-line {
		\smaller \smaller { "Copyright © Copyright 1981 by the Really Useful Group plc. and Faber Music Ltd." }
	}
	\fill-line {
		\smaller \smaller { "Typeset by Mark Veltzer <mark.veltzer@gmail.com>, Built at 10:30:56 23-02-2023, Engraved by lilypond 2.23.12" }
	}
	\fill-line {
