      ...
      \score {
        {
          ...
          s^\markup {
            \fill-line {
                \fontsize #3 \lower #1 \rotate #7 "Upbeat Jazz Blues"
              \fontsize #8
              \override #'(offset . 7)
              \override #'(thickness . 6)
              \underline \sans "Jazz Bass line for Blues in F"
...
%% just a little space
	...
	\fill-line {
		\smaller \smaller { "Typeset by Mark Veltzer <mark.veltzer@gmail.com>, Built at 10:31:28 23-02-2023, Engraved by lilypond 2.23.12" }
	}
	\fill-line {
